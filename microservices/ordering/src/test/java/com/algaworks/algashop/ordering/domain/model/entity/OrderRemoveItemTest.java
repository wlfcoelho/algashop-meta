...
import com.algaworks.algashop.ordering.domain.model.exception.OrderDoesNotContainItemException;
...
public class OrderRemoveItemTest {
  ...
  void givenDraftOrder_whenRemoveItem_shouldRecalculate() {
    ...
    Assertions.assertWith(order,
            (i) -> Assertions.assertThat(i.totalAmount()).isEqualTo(new Money("600")),
  ...
  void givenDraftOrder_whenTryToRemoveNoExistingItem_shouldGenerateException() {
    ...
    Assertions.assertThatExceptionOfType(OrderDoesNotContainItemException.class)
