...
public class OrderPersistenceEntityDisassembler {
  ...
  private Shipping toShippingValueObject(ShippingEmbeddable shippingEmbeddable){
    ...
    return Shipping.builder()
            ...
            .address(toAddressValueOject(shippingEmbeddable.getAddress()))
            .build();
  }
  ...
  private Billing toBillingValueObject(BillingEmbeddable billingEmbeddable){
    return Billing.builder()
            ...
            .address(toAddressValueOject(billingEmbeddable.getAddress()))
            .build();

  }

  private Address toAddressValueOject(AddressEmbeddable address) {
