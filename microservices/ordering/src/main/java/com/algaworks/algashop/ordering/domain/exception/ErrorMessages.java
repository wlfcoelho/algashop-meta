...
public class ErrorMessages {
  ...
  public static final String ERRROR_ORDER_STATUS_CANNOT_BE_PLACED_HAS_NO_ITEMS = "Order %s cannot be placed, it has no items";

  public static final String ERRROR_ORDER_STATUS_CANNOT_BE_PLACED_HAS_NO_SHIPPING_INFO = "Order %s cannot be placed, it has no shipping info";
  ...
  public static final String ERROR_SHOPPING_CART_ITEM_IMCOMPATIBLE_PRODUCT =  "Shopping Cart %s cannot be updated, incompatible product %s";
}
